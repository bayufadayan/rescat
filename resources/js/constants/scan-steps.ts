...
const STEPS: Record<string, string[]> = {
    'face:quick': [
        ...
        'Lepas aksesori yang menutupi wajah.',
        'Ikuti indikator penyelarasan di layar.',
        'Jaga ekspresi netral dan tetap tenang.',
        'Hindari gerakan cepat selama pemindaian.',
        'Pastikan baterai dan koneksi internet stabil.',
        'Ulangi pemindaian bila diminta sistem.',
        'Simpan hasil jika diperlukan untuk perbandingan.',
    ],
